...
Получили вариант 2 - $$(12x+3)5$$  для $$x_{1}=1, x_{2}=6$$

![Программа в файле work.asm](image/16.png){ #fig:016 width=70%, height=70% }

Если подставить 1 получается 75

Если подставить 6 получается 375
